...
public abstract class Magicians extends BaseUnit implements GameInterface{
    ...
    public Magicians(int initiative, ArrayList<BaseUnit> team, int[] damage, String name, int hp, int maxhp, int attack, int defense, int speed, int healingPower, int protectionPower, int magicPower) {
