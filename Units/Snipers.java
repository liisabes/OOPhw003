...
public abstract class Snipers extends BaseUnit implements GameInterface {
    ...
    public Snipers(int initiative, ArrayList<BaseUnit> team, int[] damage, String name, int hp, int maxhp, int attack, int defense, int speed, int rifle, int accurateShot) {
