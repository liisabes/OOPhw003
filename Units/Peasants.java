...
public abstract class Peasants extends BaseUnit implements GameInterface {
    ...
    public Peasants(int initiative, ArrayList<BaseUnit> team, int[] damage, String name, int hp, int maxhp, int attack, int defense, int speed, int crop, int house, int animal) {
